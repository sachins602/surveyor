export const NepalProvinceAndDistrict = {
  "प्रदेश नं. १": {
    "ताप्लेजुङ": [
      "फुङलिङ नगरपालिका",
